...
//	}
	...
	public void checarVencedor(){
		if(Main.inimigo.getHp()<=0){JOptionPane.showMessageDialog(faseJoin, "Azul Venceu");System.exit(0);}
		if(Main.personagem.getHp()<=0){JOptionPane.showMessageDialog(faseJoin, "Vermelho Venceu");System.exit(0);}
	}
